...
if section == 'Look at the Data':
	...
	three_cone = st.sidebar.slider('3 cone drill', min_value = 5, max_value = 7, value = 6, step = 1)
	shuttle = st.sidebar.slider('Shuttle Time', min_value = 4, max_value = 6, value = 4, step = 1)
